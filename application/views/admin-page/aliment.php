                                            ...
                                            <?php for ($i=0; $i < count($perte); $i++) {?> 
                                                <tr> 
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?= site_url("admincontroller/tomodifaliment?idaliment=".$perte[$i]->get_id_aliment())?> && idcat=2"> <i class="fas fa-pencil-alt"> </i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            ...
                                            <?php for ($i=0; $i < count($prise); $i++) { ?> 
                                                <tr> 
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?= site_url("admincontroller/tomodifaliment?idaliment=".$prise[$i]->get_id_aliment())?> && idcat=2"> <i class="fas fa-pencil-alt"> </i> </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                    </tbody>
