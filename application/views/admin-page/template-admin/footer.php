    ...
    <script src="<?=base_url()?>/assets/back/vendors/jvectormap/jquery-jvectormap.min.js"></script>
    <script src="<?=base_url()?>/assets/back/vendors/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<?=base_url()?>/assets/back/vendors/owl-carousel-2/owl.carousel.min.js"></script>
